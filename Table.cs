...
namespace CaroSpeedRun
{
    public class Table
    {
        ...
        public Table(Panel pnTable, TextBox tbIPAdress,
                             System.Windows.Forms.Timer timer, Label lbTimer
                           , int remainingTimeInSeconds, Caro caro1,
                             TextBox tbClientName, TextBox tbServerName)
        {
            this.lbResume = lbResume;
